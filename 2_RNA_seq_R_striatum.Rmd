...
#PCA Plot
```{r}
tiff(file = 'Figures/PCA/Male_STN_PCA.tiff', units="in", width=8, height=5, res=1000)
...
```{r}
tiff(file = "Figures/heatmap/High_Male_STN_heatmap.tiff", units="in", width=8, height=5, res=1000)
heatmap<-pheatmap(mat, 
         ...
         show_colnames = F,
         cluster_cols = FALSE,
         main = "High Male Striatum Heatmap")
heatmap
dev.off()
heatmap
```
...
write_tsv(High_resOrdered, file="Result_spreadsheets/High_Male_STN_results.tsv")
write.csv(High_resOrdered, file="Result_spreadsheets/High_Male_STN_results.csv")
write.csv(as.data.frame(assay(se1)), file= "Result_spreadsheets/Male_STN_counts.csv")
```
...
```{r}
tiff(file = "Figures/heatmap/Medium_Male_STN_heatmap.tiff", units="in", width=8, height=5, res=1000)
heatmap<-pheatmap(mat, 
         annotation_col=df,
         ...
         show_colnames = F,
         cluster_cols = FALSE,
         main = "Medium Male Striatum Heatmap")
heatmap
dev.off()
heatmap
```
...
write_tsv(medium_resOrdered, file="Result_spreadsheets/Medium_Male_STN_results.tsv")
write.csv(medium_resOrdered, file="Result_spreadsheets/Medium_Male_STN_results.csv")
write.csv(as.data.frame(assay(se1)), file= "Result_spreadsheets/Medium_Male_STN_counts.csv")
```
...
```{r}
tiff(file = "Figures/heatmap/low_Male_STN_heatmap.tiff", units="in", width=8, height=5, res=1000)
heatmap<-pheatmap(mat, 
         annotation_col=df,
         ...
         show_colnames = F,
         cluster_cols = FALSE,
         main = "Low Male Striatum Heatmap")
heatmap
dev.off()
heatmap
```
...
write_tsv(low_resOrdered, file="Result_spreadsheets/Low_Male_STN_results.tsv")
write.csv(low_resOrdered, file="Result_spreadsheets/Low_Male_STN_results.csv")
write.csv(as.data.frame(assay(se1)), file= "Result_spreadsheets/Low_Male_STN_counts.csv")
```
...
write.csv(data ,file="Figures/Enrichment/High_STN_gene_enrichment.csv")

```

```{r}
tiff(file = 'Figures/Enrichment/High_Male_STN_gene_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot7<-dotplot(Mgse, showCategory=5, split=".sign") +
  ...
  ggtitle("High Male Striatum Gene Enrichment")    
...
write.csv(data ,file="Figures/Enrichment/High_STN_KEGG_enrichment.csv")

```

```{r}

tiff(file = 'Figures/Enrichment/High_Male_STN_KEGG_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot8<-dotplot(Mkk2, showCategory=5, split=".sign") +
     geom_point(shape = 1,colour = "black") +
  scale_color_viridis(option = "inferno", direction = -1) +
  facet_grid(.~.sign)+
  theme(panel.spacing = unit(0.5, "cm",data = NULL), panel.grid.minor = element_blank())+
  ...
  theme(axis.text.y = element_text(size = 12), 
        strip.background = element_blank(), strip.text.x = element_text(size = 16)) +
  theme(legend.text = element_text(size = 10),legend.key.width= unit(0.3, 'cm'))+
  ggtitle("High Male Striatum KEGG Enrichment")    
...
#male_Striatum <- pathview(gene.data=gene_list, pathway.id="05012", species = kegg_organism)
...
```{r}
data<-data.frame(Mgse)
write.csv(data ,file="Figures/Enrichment/Med_STN_gene_enrichment.csv")

```

```{r}
tiff(file = 'Figures/Enrichment/Medium_Male_STN_gene_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot9<-dotplot(Mgse, showCategory=5, split=".sign") +
     geom_point(shape = 1,colour = "black") +
  scale_color_viridis(option = "inferno", direction = -1) +
  facet_grid(.~.sign)+
  theme(panel.spacing = unit(0.5, "cm",data = NULL), panel.grid.minor = element_blank())+
  ...
  theme(axis.text.y = element_text(size = 12), 
        strip.background = element_blank(), strip.text.x = element_text(size = 16)) +
  theme(legend.text = element_text(size = 10),legend.key.width= unit(0.3, 'cm'))+
  ggtitle("Medium Male Striatum Gene Enrichment")   
...
```{r}
data<-data.frame(Mkk2)
write.csv(data ,file="Figures/Enrichment/Med_STN_KEGG_enrichment.csv")

```

```{r}

tiff(file = 'Figures/Enrichment/Medium_Male_STN_KEGG_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot10<-dotplot(Mkk2, showCategory=5, split=".sign") +
     geom_point(shape = 1,colour = "black") +
  scale_color_viridis(option = "inferno", direction = -1) +
  facet_grid(.~.sign)+
  theme(panel.spacing = unit(0.5, "cm",data = NULL), panel.grid.minor = element_blank())+
  ...
  theme(axis.text.y = element_text(size = 12), 
        strip.background = element_blank(), strip.text.x = element_text(size = 16)) +
  theme(legend.text = element_text(size = 10),legend.key.width= unit(0.3, 'cm'))+
  ggtitle("Medium Male Striatum KEGG Enrichment")
...
```{r}
data<-data.frame(Mgse)
write.csv(data ,file="Figures/Enrichment/Low_STN_gene_enrichment.csv")

```

```{r}
tiff(file = 'Figures/Enrichment/Low_Male_STN_gene_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot11<-dotplot(Mgse, showCategory=5, split=".sign") +
     geom_point(shape = 1,colour = "black") +
  scale_color_viridis(option = "inferno", direction = -1) +
  facet_grid(.~.sign)+
  theme(panel.spacing = unit(0.5, "cm",data = NULL), panel.grid.minor = element_blank())+
  ...
  theme(axis.text.y = element_text(size = 12), 
        strip.background = element_blank(), strip.text.x = element_text(size = 16)) +
  theme(legend.text = element_text(size = 10),legend.key.width= unit(0.3, 'cm'))+
  ggtitle("Low Male Striatum Gene Enrichment")
...
```{r}
data<-data.frame(Mkk2)
write.csv(data ,file="Figures/Enrichment/Low_STN_KEGG_enrichment.csv")

```

```{r}

tiff(file = 'Figures/Enrichment/Low_Male_STN_KEGG_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot12<-dotplot(Mkk2, showCategory=5, split=".sign") +
    geom_point(shape = 1,colour = "black") +
  scale_color_viridis(option = "inferno", direction = -1) +
  facet_grid(.~.sign)+
  theme(panel.spacing = unit(0.5, "cm",data = NULL), panel.grid.minor = element_blank())+
  ...
  theme(axis.text.y = element_text(size = 12), 
        strip.background = element_blank(), strip.text.x = element_text(size = 16)) +
  theme(legend.text = element_text(size = 10),legend.key.width= unit(0.3, 'cm'))+
  ggtitle("Low Male Striatum KEGG Enrichment")   
...
```{r}
data<-data.frame(DO)
write.csv(data ,file="Figures/Enrichment/High_STN_disease_enrichment.csv")

```

```{r}
tiff(file = 'Figures/Enrichment/High_STN_disease_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot16<-dotplot(DO,showCategory=5, split=".sign") +
  geom_point(shape = 1,colour = "black") +
  scale_color_viridis(option = "inferno", direction = -1) +
  facet_grid(.~.sign)+
  theme(panel.spacing = unit(0.5, "cm",data = NULL), panel.grid.minor = element_blank())+
...
```{r}
data<-data.frame(DO)
write.csv(data ,file="Figures/Enrichment/Med_STN_disease_enrichment.csv")

```

```{r}
tiff(file = 'Figures/Enrichment/Med_STN_disease_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot17<-dotplot(DO,showCategory=5, split=".sign") +
  geom_point(shape = 1,colour = "black") +
  scale_color_viridis(option = "inferno", direction = -1) +
  facet_grid(.~.sign)+
  theme(panel.spacing = unit(0.5, "cm",data = NULL), panel.grid.minor = element_blank())+
...
```{r}
data<-data.frame(DO)
write.csv(data ,file="Figures/Enrichment/Low_STN_disease_enrichment.csv")

```

```{r}
tiff(file = 'Figures/Enrichment/Low_STN_disease_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot18<-dotplot(DO,showCategory=5, split=".sign") +
  geom_point(shape = 1,colour = "black") +
  scale_color_viridis(option = "inferno", direction = -1) +
  facet_grid(.~.sign)+
  theme(panel.spacing = unit(0.5, "cm",data = NULL), panel.grid.minor = element_blank())+
