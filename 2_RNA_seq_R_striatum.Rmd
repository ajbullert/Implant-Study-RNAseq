...
M_vol1<- EnhancedVolcano(res_high,
    ...
    x = 'log2FoldChange',
    y = 'pvalue',
    title = "High Exposure Male Striatum",
    subtitle = "",
...
write.csv(as.data.frame(assay(se1)), file= "Result_spreadsheets/High_Male_STN_counts.csv")
```
...
M_vol1<- EnhancedVolcano(res_medium,
    ...
    x = 'log2FoldChange',
    y = 'pvalue',
    title = "Medium Exposure Male Striatum",
    subtitle = "",
    ylim = c(0, -log10(10e-8)),
    xlim = c(log2(10e-3), -log2(10e-3)),
    FCcutoff = 1.0,
...
M_vol1<- EnhancedVolcano(res_low,
    ...
    x = 'log2FoldChange',
    y = 'pvalue',
    title = "Low Exposure Male Striatum",
    subtitle = "",
    ylim = c(0, -log10(10e-8)),
    xlim = c(log2(10e-3), -log2(10e-3)),
    FCcutoff = 1.0,
...
dot<-dotplot(Mgse, showCategory=10, split=".sign") +
  facet_grid(.~.sign)+
  ggtitle("High Male Striatum Gene Enrichment")+ theme(axis.text.y = element_text(size = 5))    
...
tiff(file = 'Figures/Enrichment/High_Male_STN_KEGG_enrichment.tiff', units="in", width=10, height=5, res=1000)
dot<-dotplot(Mkk2, showCategory=10, split=".sign") +
  facet_grid(.~.sign)+
  ggtitle("High Male Striatum KEGG Enrichment")+ theme(axis.text.y = element_text(size = 5))    
...
dot<-dotplot(Mgse, showCategory=10, split=".sign") +
  facet_grid(.~.sign)+
  ggtitle("Medium Male Striatum Gene Enrichment")+ theme(axis.text.y = element_text(size = 5))    
...
tiff(file = 'Figures/Enrichment/Medium_Male_STN_KEGG_enrichment.tiff', units="in", width=10, height=5, res=1000)
dot<-dotplot(Mkk2, showCategory=10, split=".sign") +
  facet_grid(.~.sign)+
  ggtitle("Medium Male Striatum KEGG Enrichment")+ theme(axis.text.y = element_text(size = 5))    
...
dot<-dotplot(Mgse, showCategory=10, split=".sign") +
  facet_grid(.~.sign)+
  ggtitle("Low Male Striatum Gene Enrichment")+ theme(axis.text.y = element_text(size = 5))    
...
tiff(file = 'Figures/Enrichment/Low_Male_STN_KEGG_enrichment.tiff', units="in", width=10, height=5, res=1000)
dot<-dotplot(Mkk2, showCategory=10, split=".sign") +
  facet_grid(.~.sign)+
  ggtitle("Low Male Striatum KEGG Enrichment")+ theme(axis.text.y = element_text(size = 5))    
