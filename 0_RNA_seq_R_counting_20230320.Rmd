...
```{r}
meta_data<- read_xlsx("RNAseq_bamlist_metadata.xlsx") #reading in the sample information

filenames <- file.path("P://OEH/Faculty/hlehmler/research/Lehmler Group-Amanda Bullert/4-OH-PCB52_Implant_Project/RNAseq/Novogene_files/usftp21.novogene.com/01.RawData/fastq_files/", meta_data$bam_ID)
